...
public class FoodBehaviour extends Behaviour {
    ...
    public FoodBehaviour(RandomGenerator random, Human human) {
        this.random = random;
        this.human = human;
    ...
    public FoodBehaviour(RandomGenerator random, Human human, double aggressive, double peacefully) {
        this.random = random;
        this.human = human;
    ...
    public FoodBehaviour createVariation() {
        ...
        return new FoodBehaviour(this.random, this.human, newAggressive, newPeacefully);
    }
}
