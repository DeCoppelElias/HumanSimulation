...
public class FindFoodBehaviour extends Behaviour {
    ...
    public FindFoodBehaviour(GridWorld gridWorld, Human human) {
        this.random = gridWorld.getRandom();
    ...
    public FindFoodBehaviour(
            ...
            double closestFood,
            double randomFood,
            double farthestFromOtherHumansFood,
            double mostFoodInVicinityFood)
            throws Exception {
        this.random = gridWorld.getRandom();
        this.gridWorld = gridWorld;
        this.human = human;
        ...
        if (Math.abs(sum - 1) > 0.01) throw new Exception("Chances add up to more than one: " + sum);
    ...
    public FindFoodBehaviour createVariation() throws Exception {
        ...
        double[] chances = new double[] {
            this.closestFood, this.randomFood, this.farthestFromOtherHumansFood, this.mostFoodInVicinityFood
        };
        ...
        return new FindFoodBehaviour(
                this.gridWorld,
                null,
                newClosestFood,
                newRandomFood,
                newFarthestFromOtherHumansFood,
                newMostFoodInVicinityFood);
    }
    ...
    public String toString() {
        return "FindFoodBehaviour{" + "\n" + "closestFood="
                + closestFood + "\n" + "randomFood="
                + randomFood + "\n" + "farthestFromOtherHumansFood="
                + farthestFromOtherHumansFood + "\n" + "mostFoodInVicinityFood="
                + mostFoodInVicinityFood + "\n" + '}';
    }
}
