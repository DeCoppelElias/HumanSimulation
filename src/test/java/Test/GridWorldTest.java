...
class GridWorldTest {
    ...
    public void singleHumanWalkingToFoodTest() throws Exception {
        ...
        MovementBehaviour movementBehaviour =
                new MovementBehaviour(gridWorld, null, 0, 1, new double[] {1}, new FindFoodBehaviour(gridWorld, null));
        Human human = new Human(
                gridWorld,
                new GridPosition(0, 0),
                new HumanParameters(),
                movementBehaviour,
                new FoodBehaviour(gridWorld.getRandom(), null));

        Assertions.assertEquals(
                gridWorld.toString(), "Empty Empty Empty \n" + "Empty Empty Empty \n" + "HUMAN Empty Empty \n");

        // Adding Food to GridWorld
        Food food = new Food(gridWorld, new GridPosition(2, 2));

        Assertions.assertEquals(
                gridWorld.toString(), "Empty Empty FOOD \n" + "Empty Empty Empty \n" + "HUMAN Empty Empty \n");
        ...
        gridWorld.advanceTime();
        Assertions.assertEquals(
                gridWorld.toString(), "Empty Empty HUMAN \n" + "Empty Empty Empty \n" + "Empty Empty Empty \n");
    ...
    public void fightingForFoodTest() throws Exception {
        ...
        FoodBehaviour foodBehaviour = new FoodBehaviour(gridWorld.getRandom(), null, 1, 0);
        Human human1 =
                new Human(gridWorld, new GridPosition(2, 1), new HumanParameters(), movementBehaviour, foodBehaviour);
